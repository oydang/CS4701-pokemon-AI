...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I "include\zlib" /I "include\png" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "OEMRESOURCE" /D "_AFXDLL" /D "MMX" /D "FINAL_VERSION" /D "BKPT_SUPPORT" /D "DEV_VERSION" /YX /FD /c
...
# ADD LINK32 shlwapi.lib d3dx8.lib wsock32.lib ddraw.lib dxguid.lib winmm.lib dinput.lib vfw32.lib opengl32.lib /nologo /subsystem:windows /pdb:none /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libm" /nodefaultlib:"libmmd" /out:"VisualBoyAdvance.exe" /MAPINFO:EXPORTS /MAPINFO:LINES /OPT:ref
...
# ADD CPP /nologo /MDd /W3 /GX /Od /I "include\zlib" /I "include\png" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "OEMRESOURCE" /D "_AFXDLL" /D "MMX" /D "DEV_VERSION" /D "BKPT_SUPPORT" /YX /FD /GZ /c
...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I "include\zlib" /I "include\png" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "OEMRESOURCE" /D "_AFXDLL" /D "MMX" /D "FINAL_VERSION" /D "BKPT_SUPPORT" /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x409 /d "NDEBUG" /d "_AFXDLL"
# ADD RSC /l 0x409 /d "NDEBUG" /d "_AFXDLL"
...
# ADD LINK32 shlwapi.lib d3dx8.lib wsock32.lib ddraw.lib dxguid.lib winmm.lib dinput.lib vfw32.lib opengl32.lib /nologo /subsystem:windows /machine:I386 /out:"VisualBoyAdvance.exe" /MAPINFO:EXPORTS /MAPINFO:LINES /OPT:ref
# SUBTRACT LINK32 /map /debug /nodefaultlib
...
SOURCE=..\src\i386\hq2x16.asm

!IF  "$(CFG)" == "GBA - Win32 Release"

# Begin Custom Build
OutDir=.\Release
InputPath=..\src\i386\hq2x16.asm
InputName=hq2x16

"$(OutDir)\$(InputName).obj" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	"c:\Program Files\Nasm\nasmw.exe" -D__DJGPP__ -O1 -f win32 -o $(OutDir)\$(InputName).obj $(InputPath)
...
SOURCE=..\src\i386\hq2x32.asm

!IF  "$(CFG)" == "GBA - Win32 Release"

# Begin Custom Build
OutDir=.\Release
InputPath=..\src\i386\hq2x32.asm
InputName=hq2x32
