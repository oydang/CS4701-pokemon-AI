...
extern "C"
{
void hq2x_16(unsigned char*, unsigned char*, unsigned int, unsigned int, unsigned int);
void hq2x_32(unsigned char*, unsigned char*, unsigned int, unsigned int, unsigned int);
...
{
	hq2x_16(srcPtr,dstPtr,width,height,width);
}

void hq2x32(u8 *srcPtr, u32 srcPitch, u8 * /* deltaPtr */,
            u8 *dstPtr, u32 dstPitch, int width, int height)
{
	hq2x_32(srcPtr,dstPtr,width,height,width*4);
}
